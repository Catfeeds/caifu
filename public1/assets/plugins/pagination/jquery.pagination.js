	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		getLinks:function(current_page, eventHandler) {
			var begin, end,
				...
				np = this.pc.numPages(),
				fragment = $("<div class='pagination'><span style='color: black;'>第 <em>"+(current_page+1)+"</em> 页/共 <em>"+np+"</em> 页 每页 <em>"+this.opts.items_per_page+"</em> 条记录 共 <em>"+this.maxentries+"</em> 条记录</span></div>");
